      ...
      <div className="p-6 border-bottom border-white/5">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-orange-300/60 font-medium uppercase tracking-widest">Admin Portal</p>
          </div>
        </div>
            ...
            {GOVERNORATES.map((gov) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <MapPin className={`w-4 h-4 ${selectedId === gov.id ? 'text-orange-400' : 'text-slate-500 group-hover:text-orange-400'}`} />
